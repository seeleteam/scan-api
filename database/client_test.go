...
func TestSpeed(t *testing.T) {
	...
	dbClient := NewDBClient("seele", "127.0.0.1:27017", 1)
	if dbClient == nil {
...
func TestSearch(t *testing.T) {
	...
	cnt, err := dbClient.GetTxCntByShardNumberAndAddress(0, "1111111111111111")
	if err == nil {
		fmt.Println(cnt)
	}
